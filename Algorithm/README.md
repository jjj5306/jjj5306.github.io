...
***
## 삼분 탐색
* `Unimodal`한 함수의 극대점을 찾는 방법이다. `Unimodal`이란 극대(소)점 하나를 중심으로 극대점보다 작은 구간에서 단조 증가하고 극대점보다 큰 구간에서 단조 감소하는 함수를 말한다.
...
***
## LIS
* Longest lncreasing Subsequence는 어떤 수열 $A$에서 가장 긴 증가하는 부분 수열을 구하는 문제이다. DP의 가장 대표적인 문제 중 하나이고 유사한 풀이를 적용할 수 있는 문제들이 많아서 공부해두면 좋다.

...
- ![nQueen](./img/nQueen.png) 
  퀸을 두는 경우의 수는 위의 상태트리와 같이 되어있다. 그런데, 퀸이 이동할 수 있는 경로에는 다른 퀸을 둘 수 없다. 따라서 경로를 제한한 상태트리는 아래와 같다.
  ![nQueen_backTracking](./img/nQueen_backTracking.png)
